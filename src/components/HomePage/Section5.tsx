function Section5()
{
  return (
    <div className="w-screen aspect-[16/10] bg-[#FFF9F6] place-itmes-center">
      ...
      <img src="img/main/earth.svg" alt="earth" className="w-[20.8vw] mq:w-[40vw] mb-[5.5vh] mq:mb-[3vh] mr-auto ml-auto" />
      <img src="img/main/hand.svg" alt="hand" className=" w-[18.7vw] mq:w-[36vw] mr-auto ml-auto mb-[19.2vh] mq:mb-[13vh]" />
    </div>
  );
}
