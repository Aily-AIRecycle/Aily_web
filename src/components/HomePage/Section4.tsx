import classes from "@/components/HomePage/styles/Section4.module.css";
    ...
    <div className={classes.box4}>
      ...
      <div className={classes.content}>
        <ul className={classes.info}>
          <li>
            <img src="img/main/location.svg" alt="location" />
            <h3>사용하는 Aily의 위치</h3>
          </li>
          <li>
            <img src="img/main/circle_info.svg" alt="info" />
            <h3>상세정보</h3>
          </li>
          <li>
            <img src="img/main/battery.svg" alt="battery" />
            <h3>쓰레기별 적재량</h3>
          </li>
        </ul>
        <div className={classes.aily}>
          ...
          <div className={classes.type}>
            <div className={classes.normal}>
              ...
              <img src="img/main/line.svg" alt="line" />
            </div>
