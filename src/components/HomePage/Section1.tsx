...
function Section1()
{
  ...
  return (
    <div className="grid place-items-center mt-[13.8vh] mq:mt-[8vh]">
      <h1 className="text-5xl font-semibold mb-[2.8vh] mq:text-3xl">자연을 생각하는 분리수거 로봇</h1>
      <h2 className="text-2xl font-light text-[#726969] mb-[6.5vh] mq:text-lg">Aily를 통해 자동으로 분리수거를 해보세요.</h2>
