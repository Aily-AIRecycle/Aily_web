    ...
    <div className="bg-[#FFE8DF] w-full text-center aspect-[16/10]">
      <div className=" mt-[13.8vh] mq:mt-[8vh] mq:mb-[8vh]">
        ...
        <div ref={ref} className="relative grid place-items-center">
          <animated.img
            style={bill}
            src="img/main/money_bill.svg"
            alt="bill"
            className="absolute start-px top-0 w-[12.5vw] ml-[13vw] mt-[-5.5vh] mq:mt-[-2.75vh]"
          />
          <animated.img
            style={coin}
            src="img/main/coin.svg"
            alt="coin"
            className="absolute w-[8.8vw] start-px mt-[36vh] mq:mt-[18vh] ml-[21vw]"
          />
          ...
          <div className="z-10 aspect-square w-1/3 bg-[#ffffff] rounded-[5.6vw] border-solid border-8 border-[#F8B195] shadow-[1vw_1vw_0.5vw_0.25vw_rgba(0,0,0,0.25)]">
            ...
            />
            <h2 className="mt-[10vh] mq:mt-[2.3vh] ml-[11vw] text-[2.5vw] mq:text-[2vw] text-left text-[#3e3e3e]">
              홍길동님의 포인트
            </h2>
            <animated.h1
              ref={ref}
              className="text-[6.3vw] mt-[6.2vw] text-[#3e3e3e]"
            >
          ...
          <animated.img
            style={cash}
            src="img/main/cash.svg"
            alt="cash"
            className="absolute w-[9.6vw] end-px mr-[18.5vw]"
          />
        </div>
      </div>
    </div>
